...
public class dialogueZone : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Transform nameTextPanel = dialogueUI.transform.Find("Character Name");
        namePanel = nameTextPanel.gameObject;
        ...
        {
            Debug.LogError("Cannot find Name Text Panel");
        }

        Transform dialogueTextPanel = dialogueUI.transform.Find("Dialogue Text");
        dialoguePanel = dialogueTextPanel.gameObject;
    ...
    void Update()
    {
        ...
        void ShowLine()
        {
            ...
            if (currentLine < lines.Length)
            {
                ...
                if (childCount == 0)
                {
                    choiceOptions.Add("default");
                    GameObject choiceObj = Instantiate(choicePrefab, choiceContainer.transform);
                    TextMeshProUGUI choiceTMP = choiceObj.GetComponentInChildren<TextMeshProUGUI>();
                    if (choiceTMP != null)
                    {
                        choiceTMP.text = "Continue";
                    }
                    childCount++;
                }
